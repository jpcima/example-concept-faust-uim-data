...
class mydsp : public dsp {
 ...
 public:
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, Damp, "Freeverb/[0]/Damp", fVslider1, 0.5f, 0.0f, 1.0f, 0.025000000000000001f) \
		p(VERTICALSLIDER, RoomSize, "Freeverb/[0]/RoomSize", fVslider0, 0.5f, 0.0f, 1.0f, 0.025000000000000001f) \
		p(VERTICALSLIDER, StereoSpread, "Freeverb/[0]/Stereo Spread", fVslider3, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, Wet, "Freeverb/Wet", fVslider2, 0.33329999999999999f, 0.0f, 1.0f, 0.025000000000000001f)
